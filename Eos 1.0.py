...
# setting up API 'sapi5' and setting it to male voice
...
# setting greeting from VA according to time
def wishMe():
...
if __name__ == '__main__':
    ...
    # ehile the code is true all the commands will run
    while True:
        ...
        if 'thank you' in statement:
            ...
            if 'no' in statement:
                ...
                break
        # this command will search wikipedia for the search terms you say and will return a summary of the results
    ...
    if 'yes' in statement:
        ...
        button.click()
# gives the voice microphone one seconds before it asks or listens
time.sleep(1)
